...
export const GLOBE = {
  ...
  /** Landmass outline color (warm gold) */
  LAND_OUTLINE_COLOR: 'rgba(212, 168, 83, 0.42)',
  LAND_OUTLINE_COLOR_HEX: '#d4a853',
  LAND_OUTLINE_OPACITY: 0.42,
  LAND_OUTLINE_GLOW_OPACITY: 0.16,
  LAND_OUTLINE_SURFACE_ALTITUDE: 0.002,
  LAND_OUTLINE_GLOW_ALTITUDE: 0.006,
  LAND_OUTLINE_WIDTH: 1,
  LAND_TEXTURE_WIDTH: 2048,
  LAND_TEXTURE_HEIGHT: 1024,
  OCEAN_BASE_COLOR_HEX: '#07110f',
  OCEAN_EQUATOR_COLOR_HEX: '#163729',
  OCEAN_POLE_COLOR_HEX: '#050808',
  LAND_FILL_COLOR_HEX: '#244a34',
  LAND_FILL_HIGHLIGHT_HEX: '#6f7040',
  LAND_FILL_OPACITY: 0.62,
  LAND_TEXTURE_OUTLINE_OPACITY: 0.34,
  LAND_TEXTURE_SHADOW_OPACITY: 0.22,
  LAND_BUMP_SCALE: 0.03,
} as const;
